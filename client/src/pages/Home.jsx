...
export default function Home() {
  ...
  return (
    <div className=' bg-summerBeach dark:bg-mystery bg-contain py-[20px]'>
      {/* HERO */}
      <div className='flex flex-col gap-6 p-28 mb-[20px] max-w-6xl mx-auto border border-solid border-gray-400 rounded-[10px] shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-indigo-500/90 bg-summer dark:bg-sky bg-cover '>
        ...
        >
          <div className="bg-orange-300 dark:bg-indigo-400 max-w-[150px] text-center rounded-[5px] p-[5px] hover:text-indigo-700 hover:font-bold hover:scale-x-105 tranform transition-transform">
            View all posts
          </div>
        </Link>
      </div>
      ...
      {/* RECENT POSTS */}
      <div className='w-full mx-auto p-3 gap-8 py-7 '>
