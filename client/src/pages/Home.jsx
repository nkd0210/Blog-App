...
export default function Home() {
  ...
  return (
    <Wrapper className='box bg-white dark:bg-[#182029]'>
      <div className='mx-[150px] p-[5px] md:p-[12px] lg:py-[20px] lg:px-0 '>
          ...
          {/* RECENT POSTS */}
          <div className=' max-w-full gap-8 py-7'>
            {posts && posts.length > 0 && (
              <div className='flex flex-col gap-6'>
                <h2 className='text-[26px] font-semibold text-center text-gray-600 dark:text-purple-400 '>Recent Posts</h2>
                <div className='flex justify-center flex-wrap gap-[30px] sm:gap-[50px] border py-[20px] rounded-[20px] border-gray-300 dark:border-indigo-400 bg-gray-100 dark:bg-[#11181f]'>
                  {posts.map((post) => (
