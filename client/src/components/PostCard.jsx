...
export default function PostCard({ post }) {
  ...
  return (
    <div className='group relative w-full border border-gray-400 dark:border-indigo-400 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[430px] transition-all shadow-lg shadow-gray-500/50 dark:shadow-indigo-500/90'>
